...
Cylinder::Cylinder(Vec3 pos, Size2 size, Color color, int density, float sectorScale)
{
	this->pos = pos;
	this->size = size;
	this->color = color;
...
Cylinder::Cylinder(Vec3 pos, Size2 size, Color color, char startAxe, int density, float sectorScale) {
	this->pos = pos;
	this->size = size;
...
void Cylinder::render(Vec3 pos)
{
	Vec3 drawPos = { this->pos.x + pos.x, this->pos.y + pos.y, this->pos.z + pos.z };
