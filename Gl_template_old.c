...
void szescian(void)
{
	glPolygonMode(GL_FRONT_AND_BACK, GL_FILL);
	{
		...
		*/
		...
		double radians = (90 - degree) * (GL_PI / 180);
		float axis1 = sin(radians) * 10;
		float axis2 = cos(radians) * 10;

		GLfloat p1[3] = { 10.0f - axis1,0.0f,0.0f + axis2 };
		//GLfloat p2[3] = { 10.0f,0.0f,0.0f };
		//GLfloat p3[3] = { 10.0f,10.0f,0.0f };
		GLfloat p4[3] = { 10.0f - axis1,10.0f,0.0f + axis2 };
	...
	LPARAM  lParam)
{
	...
	case WM_KEYDOWN:
	{
		...
		if (wParam == 'A' && degree > 0)
			degree -= 1;

		if (wParam == 'D' && degree < 90)
			degree += 1;
